package com.zztl.zuul.filter;

import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import com.zztl.zuul.enum_type.FilterType;
import com.zztl.zuul.util.ResponseUtil;
...
public class PreFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        try {
            ...
            System.out.println("查看具体的结果:"+request.getRequestURI());
